...
export const getSigningSecret = (http, params) => {
  return raw.get(http, getWebhookSigningSecretUrl(params));
};
export const getRetryPolicy = (http, params) => {
...
export const update = async (http, params, rawData, headers) => {
...
export const upsertSigningSecret = async (http, params, rawData) => {
  const data = copy(rawData);
  return raw.put(http, getWebhookSigningSecretUrl(params), data);
};
export const upsertRetryPolicy = async (http, params, rawData) => {
  const data = copy(rawData);
...
export const deleteSigningSecret = async (http, params) => {
  return raw.del(http, getWebhookSigningSecretUrl(params));
};
export const deleteRetryPolicy = async (http, params) => {
